...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delayBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                tvDelay.setText(Integer.toString(progress * 20) + " мс");
                delay = progress * 20;
            }
        });
        ...
        btnDraw.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(action==0){
                    ...
                    else Toast.makeText(MainActivity.this, "Укажите количество частиц", Toast.LENGTH_SHORT).show();

                    if(etTemp.getText()!=null)
                        T = Integer.parseInt(etTemp.getText().toString());
                    else Toast.makeText(MainActivity.this, "Укажите температуру частиц", Toast.LENGTH_SHORT).show();
                    initData();
                    layoutInteractive.setVisibility(View.VISIBLE);
                    layoutValues.setVisibility(View.GONE);
                    btnDraw.setText("Начать");
                    action=1;
                }
                else if(action==1){
                    action=2;
                    btnDraw.setText("Остановить");
    ...
    public class ReloadTask extends AsyncTask{
        ...
        protected void onPostExecute(Object o) {
            ...
            plot.addSeries(series, series2Format);
            plot.redraw();
            tvOffset.setText("D=" + diffusion +" м^2/с\nt=" + time +" с");
